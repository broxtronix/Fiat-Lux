...
///
#ifndef __XENON_CORE_FUNDAMENTALTYPES_H__
#define __XENON_CORE_FUNDAMENTALTYPES_H__
...
#define XENON_BIG_ENDIAN 4321
#define XENON_LITTLE_ENDIAN 1234
#define XENON_BYTE_ORDER XENON_LITTLE_ENDIAN
#else
#include <sys/types.h>
#ifdef BYTE_ORDER
#define XENON_BIG_ENDIAN BIG_ENDIAN
#define XENON_LITTLE_ENDIAN LITTLE_ENDIAN
#define XENON_BYTE_ORDER BYTE_ORDER
#else
#define XENON_BIG_ENDIAN __BIG_ENDIAN
#define XENON_LITTLE_ENDIAN __LITTLE_ENDIAN
#define XENON_BYTE_ORDER __BYTE_ORDER
#endif
#endif
...
namespace xenon {
  ...
  template <> struct AccumulatorType<xenon::uint8>   { typedef xenon::int32   type; };
  template <> struct AccumulatorType<xenon::int8>    { typedef xenon::int32   type; };
  template <> struct AccumulatorType<xenon::uint16>  { typedef xenon::int32   type; };
  template <> struct AccumulatorType<xenon::int16>   { typedef xenon::int32   type; };
  template <> struct AccumulatorType<xenon::uint32>  { typedef xenon::int64   type; };
  template <> struct AccumulatorType<xenon::int32>   { typedef xenon::int64   type; };
  template <> struct AccumulatorType<xenon::uint64>  { typedef xenon::int64   type; };
  template <> struct AccumulatorType<xenon::int64>   { typedef xenon::int64   type; };
  template <> struct AccumulatorType<xenon::float32> { typedef xenon::float64 type; };
  template <> struct AccumulatorType<xenon::float64> { typedef xenon::float64 type; };
  ...
  template <class T> struct FloatType { typedef xenon::float32 type; };
  template <> struct FloatType<xenon::uint32>  { typedef xenon::float64 type; };
  template <> struct FloatType<xenon::int32>   { typedef xenon::float64 type; };
  template <> struct FloatType<xenon::uint64>  { typedef xenon::float64 type; };
  template <> struct FloatType<xenon::int64>   { typedef xenon::float64 type; };
  template <> struct FloatType<xenon::float64> { typedef xenon::float64 type; };
...
#endif // __XENON_CORE_FUNDAMENTALTYPES_H__
