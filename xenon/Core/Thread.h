...
///   a POD class with an initializer macro XENON_RUNONCE_INIT.  It must
...
///   statically initialized to XENON_RUNONCE_INIT.)

#ifndef __XENON_CORE_THREAD_H__
#define __XENON_CORE_THREAD_H__
...
#define XENON_RUNONCE_INIT { BOOST_ONCE_INIT }
  ...
  // and statically initialize them to XENON_RUNONCE_INIT.
  struct RunOnce {
