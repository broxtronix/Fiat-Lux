...
///
#ifndef __XENON_CORE_TYPE_DEDUCTION_H__
#define __XENON_CORE_TYPE_DEDUCTION_H__
...
#define _XENON_INTERNAL_TYPE_DEDUCTION(Type, Number)            \
    ...
    _XENON_INTERNAL_TYPE_DEDUCTION(              char,  100);
    _XENON_INTERNAL_TYPE_DEDUCTION(       signed char,  200);
    _XENON_INTERNAL_TYPE_DEDUCTION(     unsigned char,  300);
    _XENON_INTERNAL_TYPE_DEDUCTION(      signed short,  400);
    _XENON_INTERNAL_TYPE_DEDUCTION(    unsigned short,  500);
    _XENON_INTERNAL_TYPE_DEDUCTION(        signed int,  600);
    _XENON_INTERNAL_TYPE_DEDUCTION(      unsigned int,  700);
    _XENON_INTERNAL_TYPE_DEDUCTION(       signed long,  800);
    _XENON_INTERNAL_TYPE_DEDUCTION(     unsigned long,  900);
#if defined(BOOST_HAS_LONG_LONG)
    _XENON_INTERNAL_TYPE_DEDUCTION(  signed long long, 1000);
    _XENON_INTERNAL_TYPE_DEDUCTION(unsigned long long, 1100);
#endif
#if defined(BOOST_HAS_MS_INT64)
    _XENON_INTERNAL_TYPE_DEDUCTION(          __int64;, 1200);
    _XENON_INTERNAL_TYPE_DEDUCTION( unsigned __int64;, 1300);
#endif
    _XENON_INTERNAL_TYPE_DEDUCTION(             float, 1400);
    _XENON_INTERNAL_TYPE_DEDUCTION(            double, 1500);
    _XENON_INTERNAL_TYPE_DEDUCTION(       long double, 1600);
  }}
  ...
  struct TypeDeductionHelper {
    ...
    //
    // (Implementation note: _XENON_INTERNAL_TYPE_DEDUCTION contains an
