...
/*
  ...
  */  
    ...
    cout << jack_connect(client, "otherscope:out_w","simulator:in_g") << "\n";
    cout << jack_connect(client, "system:capture_1","otherscope:in_l") << "\n";
    cout << jack_connect(client, "system:capture_2","otherscope:in_r") << "\n";
