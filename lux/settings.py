...
organization_name = 'False Profit LLC'
organization_domain = 'false-profit.com'
application_name = 'Fiat Lux'

class LuxSettings(object):
    """
    ...
    def __setattr__(self, key, value):
        ...
        if not self.__dict__.has_key('_LuxSettings__initialised'):
