...
class SimplePlugin(LuxPlugin):
    ...
    description = """
    i had a accident.
    i don't know wtf this is doing, so don't ask.
    """
    def __init__(self):
        ...
        self.spatial_resonance = 4 #float(int(4)) 
        self.spatial_resonance_amplitude = 1 
        self.r_prime = 1 #37
        self.g_prime = 2 #23
        self.b_prime = 3 #128
    ...
    def draw(self):
        ...
        while theta < 2 * math.pi * self.max_cycles and n < self.max_segments:
            ...
            x += math.cos(angle*self.spatial_resonance)*self.spatial_resonance_amplitude
            y += math.sin(angle*self.spatial_resonance)*self.spatial_resonance_amplitude
